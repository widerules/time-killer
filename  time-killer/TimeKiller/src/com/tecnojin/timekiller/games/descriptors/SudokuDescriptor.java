...
public class SudokuDescriptor extends GameDescriptor{
	...
	private void initStats(Context c) {
		...
		statistics=new StatSet("stat_sudoku.txt",playedEasy,terminatedEasy,percentEasy,playedMedium,terminatedMedium,percentMedium,playedMHard,terminatedHard,percentHard);
		statistics.load(c);
